...
interface Step1Props {
  ...
  updateFormData: (data: Partial<(typeof Step1Props)["formData"]>) => void
}
    ...
    <Card>
      <CardContent className="pt-6">
        <div className="space-y-6">
          <div>
            <h2 className="text-xl font-semibold mb-4">Create Your Memecoin</h2>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground mt-1">Recommended: 512x512px JPG, PNG or GIF</p>
                </div>
              </div>
            </div>
